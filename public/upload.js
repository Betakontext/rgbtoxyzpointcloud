  ...
  if (file && validFileTypes.includes(file.type) && file.size <= maxSizeInBytes) {
    ...
    try {
      ...
      try {
        ...
        const supabaseKey = ''eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVua3Bkc2Vjdm9wd2h4am9kbWFnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzgxMzQ0NjksImV4cCI6MjA1MzcxMDQ2OX0.4MwAFohH9DHqYu1liHeXRJTLc6ZU_AMfmVXwnnCjYdg'; // Replace with your actual Supabase ke'; // Replace with your actual Supabase key
